export default function ThemeEventCard({
  img,
  alt,
  title,
  date,
  ...
  return (
    <div className="col">
      <div className="card h-100 theme-event-card p-2 fade-up">
        <img
          src={img}
          className="card-img-top mb-6 theme-event-card img-hover-bigger"
          alt={alt}
        />
        ...
        <div className="card-body">
          ...
          {String(desc)
            ...
            .map((line, idx) => (
              <p
                key={idx}
                className={`card-text p4 ${idx === 0 ? "mb-1" : ""}`}
              >
                {line}
              </p>
            ))}
        ...
        <div className="text-center">
          <button
            className="btn b2 btn-primary rounded-pill btn-reserve"
            type="button"
            onClick={onClick} // 這裡觸發父組件傳進來的 navigate
          >
            查看詳情
          </button>
        </div>
