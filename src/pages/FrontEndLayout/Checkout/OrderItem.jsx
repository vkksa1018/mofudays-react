    ...
    <>
      <div className="table-container-bg fs-14-sm d-flex py-4 py-20-sm px-4-sm pe-12-sm mb-2 flex-wrap-sm">
        ...
        <div className="col-table-4 col-table-6-sm ps-24-sm">
          <p className="table-title fs-16-sm fw-bold mb-2 mb-4-sm">
            {planName}
          </p>
        ...
        {/* 小計 */}
        <div className="col-table-1-5 text-end-sm d-flex justify-content-center align-items-center d-none-sm">
